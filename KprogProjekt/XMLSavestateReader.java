...
public final class XMLSavestateReader {
	...
	private static Element getMice(){
		return XML_Helper.getRoot(XMLSavestateReader.FILEPATH).getChild("mice");
	}
	
	private static Element getHounds(){
		return XML_Helper.getRoot(XMLSavestateReader.FILEPATH).getChild("hounds");
	}
	
	private static Element getPlayer(){
		return XML_Helper.getRoot(XMLSavestateReader.FILEPATH).getChild("players");
	}
	...
	public static Element getCounters(){
		return XML_Helper.getRoot(XMLSavestateReader.FILEPATH).getChild("counters");
	}
