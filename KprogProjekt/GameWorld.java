...
public class GameWorld extends World {
    ...
    public GameWorld(int playerCount) {
        ...
        //this.setGui();
        System.out.println("----> inside GameWorld Konstruktor");
        Greenfoot.stop();
        System.out.println("Gameworld stoped.");
        this.setBackground();
    ...
    private void setUpWorld(final int playerCount) {
        System.out.println("----> inside setUpWorld");
        this.setWalls();
        ...
        this.setMice();
        Greenfoot.start();
        System.out.println("-- started Gameworld");
        System.out.println("---- leave setUpWorld");
    }
